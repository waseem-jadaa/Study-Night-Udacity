...
export const renderCardSetsPage = () => {
  ...
  container.setAttribute("data-cy", "card-set-page");
  ...
  toggleFormButton.setAttribute("data-cy", "toggle-create-set-form");
...
const createSetPreviewCard = (set, setContainer) => {
  ...
  if (set.id === 1) { 
      setCard.setAttribute("data-cy", "first-card-set");
  }
...
const createCardSets = () => {
  ...
  setContainer.setAttribute("data-cy", "set-list");
